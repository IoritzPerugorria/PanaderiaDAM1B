...
INSERT INTO INGREDIENTES (NOMBRE, PRECIO, STOCK, IMAGEN) VALUES ("Harina", 0.70, 30, "harina.gif"); -- 1
...
SELECT I.IMAGEN, N.CANTIDAD, I.NOMBRE FROM PRODUCTOS AS P
INNER JOIN NECESITA AS N ON N.PR_ID = P.ID
INNER JOIN INGREDIENTES AS I ON N.ING_ID = I.ID
WHERE P.ID = 2;
